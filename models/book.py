...
class Book:
    """
    Book model class representing a book entity with all required properties.
    """
    ...
    def __repr__(self):
        ...
        return (f"Book(id={self.id}, title='{self.title}', author='{self.author}', "
                f"published_date={self.published_date}, language='{self.language}', "
                f"no_of_pages={self.no_of_pages})")
    
    def __str__(self):
        """
        Return a human-readable string representation of the Book instance.
        """
